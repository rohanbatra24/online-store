...
router.get('/admin', (req, res) => {
	...
	db
		...
		.then(() => {
			db
				.select('products.id', 'products.title', 'products.image', 'products.price', 'category_id','categories.name')
				.table('products')
...
router.post('/admin/deleteproduct/:id', (req, res) => {
	if (req.session.userName === 'Admin') {
		...
		db
			...
			.then(() => {
				db
					.select('products.id', 'products.title', 'products.image', 'price', 'products.category_id')
					.table('products')
					.join('categories', 'categories.id', '=', 'category_id')
					.then((products) => {
